...
it('Verify public profile page link', () => {
  cy.visit('https://passport-staging.lysto.io/passport/Rahul')
...
it('Verify terms and conditions page link', () => {
  cy.visit('https://passport-staging.lysto.io/terms-and-conditions')
  cy.contains('A. SCOPE').should('be.visible')
});
it('Verify privacy policy page link', () => {
  cy.visit('https://passport-staging.lysto.io/privacy-policy')
